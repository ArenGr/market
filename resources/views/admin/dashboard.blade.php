    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <p> You can find the complete code on <a href="https://github.com/ArenGr/market" target="_blank">
            ...
            <div class="form-group col-md-12">
                <div class="alert alert-success" role="alert">
                    ...
                    <a href="https://github.com/ArenGr/market" target="_blank" class="btn btn-sm btn-primary mr-2">
                        Github</a>
                    <a href="https://github.com/ArenGr/market" target="_blank" class="btn btn-sm btn-success">
                        Demo</a>
                </div>
            </div>
        </div>
